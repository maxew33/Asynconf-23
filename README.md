# Du Design à l'Interaction : la Magie du CSS (30-10-23)

![asynconf banner](https://github.com/maxew33/Asynconf-23/blob/master/img/banner.jpeg)

Ce repository contient le code présenté lors de l'Asynconf' 2023 ainsi que les liens vers les projets, personnes et sites mentionnés.
...
## Mes Réseaux
- [Linkedin](https://www.linkedin.com/in/maxime-malfilatre/)
- [Github](https://github.com/maxew33)
- [CodePen](https://codepen.io/maxew33)
...
- [CodePen Challenge](https://codepen.io/challenges)
- [Le Repaire du Web](https://discord.com/invite/RMgs59dn)

### Personnes à Suivre 
- [Alvaro Montoro](https://dev.to/alvaromontoro)
- [Lynn Fisher](https://lynnandtonic.com/)
- [Amit Sheen](https://amitsh.com/)
- [Jane Ori](https://dev.to/janeori)
- [Temani Afif](https://dev.to/afif)

### Chaînes à Suivre
- [Ecole du Web](https://www.youtube.com/@EcoleduWeb)
- [Grafikart](https://www.youtube.com/@grafikart)
- [Kevin Powell](https://www.youtube.com/@KevinPowell)

## Aperçu
![snapshot](https://github.com/maxew33/Asynconf-23/blob/master/img/screenshot.png)
